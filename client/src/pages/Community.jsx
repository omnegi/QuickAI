      ...
      <div className='bg-white h-full w-full rounded-xl overflow-y-scroll'>
        {creations.map((creation, index) => (
          <div key={index} className='relative group inline-block pl-3 pt-3 w-full sm:max-w-1/2 lg:max-w-1/3'>
            ...
            <div className='absolute bottom-0 left-3 top-0 right-0  text-white p-3 rounded-lg flex justify-end items-end gap-2 group-hover:bg-gradient-to-b from-transparent to-black/80 group-hover:justify-between'>
